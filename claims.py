...
df_claims = df_claims[['TXT_UIIC_OFF_CODE','COMPANYNAME','TXT_LEADER_OFFICE_CODE','Customer Name','TXT_DEPARTMENTNAME','TXT_POLICY_NO_CHAR','Policy From','Policy Upto','NUM_SHARE_PCT','TXT_MASTER_CLAIM_NO','DAT_LOSS_DATE','TXT_NATURE_OF_LOSS','LOSS_AMOUNT','EXPENSE_AMOUNT','Total claim amount','NUM_VOUCHER_NO','DAT_ACCOUNTING_DATE','TXT_URN_CODE']]

df_claims = df_claims.set_axis(['UIIC Office Code','Name of coinsurer','Follower Office Code','Name of insured','Department','Policy Number','Policy start date','Policy end date','Percentage of share','Claim Number','Date of loss','Cause of loss','Loss amount','Expense amount','Total claim amount','Settlement voucher number','Voucher date','URN Code'],axis=1,inplace=False)
